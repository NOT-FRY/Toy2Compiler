...
int a = 1;
double b = 2.2;
char* valore = stringCopy("nok");

sommac ( a,x,b,&taglia,&risultato );
valore = stringCopy(stampa ( concatString(concatString(concatInt(concatString(concatDouble(concatString(concatInt("la somma di ",a,true)," e "),b,true)," incrementata di "),c,true)," e' "),taglia) ) );

valore = stringCopy(stampa ( concatDouble("ed e' pari a ",risultato,true) ) );
...
if ( *result > 100 ){
char* valore = stringCopy("grande");

*size = stringCopy(valore);

 }
else if ( *result > 50 ){
char* valore = stringCopy("media");

*size = stringCopy(valore);

}
 else{
char* valore = stringCopy("piccola");
